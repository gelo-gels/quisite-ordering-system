...
@main.route("/order_made", methods=['POST'])
@login_required
def order_made():
    '''
...
@main.route("/order_preview", methods=['POST'])
@login_required
def order_preview():
    '''
...
@main.route("/search-shops", methods=['POST'])
def search_shops():
...
@main.route("/order-detail", methods=['POST'])
def order_detail():
...
@main.route("/search-MyOrders", methods=['POST'])
def search_MyOrders():
...
@main.route('/search-ShopOrders', methods=['POST'])
...
@main.route("/search-transactionRecord", methods=['POST'])
...
@main.route("/order-delete", methods=['POST'])
def order_delete():
...
@main.route("/order-complete", methods=['POST'])
def order_complete():
...
@main.route("/shop_register", methods=['POST'])
@login_required
def shop_register():
    # get input values
    user_info = session.get('user_info')
...
@main.route("/register-shop_name-check", methods=['POST'])
...
@main.route("/shop_add", methods=['POST'])
@login_required
def shop_add():
    # get input values
    user_info = session.get('user_info')
...
@main.route("/edit_price_and_quantity", methods=['POST'])
...
@main.route('/top_up', methods=['POST'])
@login_required
def top_up():
    UID = session['user_info']['UID']
    try:
